    ...
    return (
        <div className="flex justify-center items-center">
            <div className="w-full max-w-[1440px] px-4 mx-auto">
                ...
                <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-lg flex flex-wrap md:flex-nowrap space-y-4 mx-auto md:space-y-0 md:space-x-4">
                    <div className="flex flex-col w-full md:w-1/5">
                        <label htmlFor="destination" className="text-gray-700 mb-2">Destination</label>
                        <input
                            type="text"
                            id="destination"
                            value={destination}
                    ...
                    <div className="flex flex-col w-full md:w-1/5 ">
                        <label htmlFor="travelType" className="text-gray-700 mb-2 ">Travel Type</label>
                        <select
                            id="travelType"
                            value={travelType}
