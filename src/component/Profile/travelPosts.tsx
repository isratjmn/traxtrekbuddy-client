		...
		<div className="container mx-auto px-4 py-6">
			...
			<div className="overflow-x-auto">
				<div className="max-h-96 overflow-y-auto">
					<table className="min-w-full bg-white border w-full border-gray-300 shadow-lg">
						...
						<tbody className="divide-y divide-gray-200">
							{trips?.map((trip: any, index: any) => (
								<tr key={trip.id} className="hover:bg-gray-100">
									...
									<td className="px-6 font-bold py-4 whitespace-nowrap border-r border-gray-200">
										{trip.destination}
									</td>
